  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <h2 className="lg:text-3xl sm:text-xl font-bold tracking-tight mb-6">Account Settings</h2>

        <div className="flex flex-col leading-none sm:flex-row items-start sm:items-center sm:space-x-6 space-y-4 sm:space-y-0">
          <img
            src="https://randomuser.me/api/portraits/women/44.jpg"
            alt="profile"
            className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover"
          />
          <div className="text-sm sm:text-base lg:w-40">
