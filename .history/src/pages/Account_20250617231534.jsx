  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col flex-row items-start items-center space-x-6 space-y-4 space-y-0">
          <img
            src="https://randomuser.me/api/portraits/women/44.jpg"
            alt="profile"
            className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover mt-4"
          />
          <div className="text-sm sm:text-base lg:w-40 leading-none">
            <h3 className="font-semibold text-gray-800 text-md text-lg">{userData.fullName}</h3>
            <p className="text-gray-600 text-lg mb-1">{userData.email}</p>
            <p className="text-gray-600 leading-4.5">
