  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-sm space-y-6">
        <div>
          <h2 className="text-center text-3xl leading-none font-bold tracking-tight">Sign in to your PopX account</h2>
          <p className="mt-3 text-center text-md text-gray-800">
